...
- *0* is rendered in the DOM because it is considered valid React node. This means that if `o' is the result expression, it will appear in your UI.
...
In React , curly braces {} used to embed js expres. within jsx.
The double curly braces represnts the js obj. being created inside jsx.
